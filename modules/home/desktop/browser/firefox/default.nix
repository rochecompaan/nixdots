...
let
  ...
  sharedFirefoxProfile = {
    extraConfig = builtins.concatStringsSep "\n" [
      (sanitizeFirefoxPrefs (builtins.readFile "${betterfox}/Securefox.js"))
      (sanitizeFirefoxPrefs (builtins.readFile "${betterfox}/Fastfox.js"))
      (sanitizeFirefoxPrefs (builtins.readFile "${betterfox}/Peskyfox.js"))
    ];
    ...
    settings = {
      ...
      # Enable Home Manager-managed extensions on first startup.
