...
in
{
  ...
  home.file = {
    ...
    # New extensions
    ".pi/agent/extensions/agent-team.ts".source = ./extensions/agent-team.ts;
    ...
    ".pi/agent/skills/selecting-subagent-models/SKILL.md".source =
      ./skills/selecting-subagent-models/SKILL.md;
